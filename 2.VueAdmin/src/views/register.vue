<template>
	<div>
		<div class="container" :style='{"minHeight":"100vh","alignItems":"center","background":"url(http://codegen.caihongy.cn/20231119/4d40a5c1a21546ddb769bc21fd89af7a.jpg)","display":"flex","width":"100%","backgroundSize":"100% 100%","backgroundPosition":"center center","backgroundRepeat":"no-repeat","justifyContent":"center"}'>
			<el-form v-if="pageFlag=='register'" :style='{"border":"0px solid #f6f6f6","padding":"40px 40px 40px 580px","margin":"60px 0","alignItems":"flex-start","textAlign":"center","display":"flex","justifyContent":"space-between","minHeight":"600px","borderRadius":"0px","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20231119/f4513a2051d84f3eb0fcde72c88f4c84.png) no-repeat 80px 90% / 250px,url(http://codegen.caihongy.cn/20231119/2359b77423a443648e74713e5846b20e.png) no-repeat 20px 20px / auto 110px,url(http://codegen.caihongy.cn/20231119/a0ad204cb6af4417af99ee45b955f6b3.png) no-repeat 1% center / 480px 99%,#fff","width":"880px","height":"auto"}' ref="rgsForm" class="rgs-form" :model="rgsForm" :rules="rules">
				<div v-if="true" :style='{"padding":"0px","margin":"0 0 10px","borderColor":"#eee","color":"#333","textAlign":"left","display":"inline-block","background":"none","borderWidth":"0px","width":"100%","lineHeight":"40px","fontSize":"20px","borderStyle":"solid","fontWeight":"500"}' class="title">校园数字化图书馆系统注册</div>
				...
				<el-form-item :style='{"padding":"0 0px","margin":"0 20px 5px","textAlign":"left","flexWrap":"wrap","display":"flex","width":"230px","fontSize":"inherit","position":"relative","height":"auto"}' class="list-item" v-if="tableName=='yonghu'">
					<div v-if="true" :style='{"padding":"0 6px","color":"#333","textAlign":"right","left":"-120px","display":"inline-block","width":"120px","lineHeight":"40px","fontSize":"14px","position":"absolute","order":"2"}' class="lable" :class="changeRules('shenfen')?'required':''">身份：</div>
				...
				<button :style='{"border":"0px solid #4FA1D9","cursor":"pointer","padding":"0 24px","boxShadow":"0 0 0px rgba(64, 158, 255, .5)","margin":"20px 20px 0 20px","color":"#fff","display":"inline-block","letterSpacing":"4px","borderRadius":"4px","background":"#333","width":"auto","fontSize":"16px","height":"40px","order":"11"}' type="button" class="r-btn" @click="login()">注册</button>
