...
<style lang="scss" scoped>
	...
	.el-menu-horizontal-2 .el-submenu.other ::v-deep .el-submenu__title {
				border: 0;
				cursor: pointer;
				padding: 10px 30px 10px 15px;
				margin: 0;
	...
	.el-menu-horizontal-2 .el-submenu.other ::v-deep .el-submenu__title:hover {
			}
	
	.el-menu-horizontal-2 .el-submenu.other ::v-deep .el-submenu__title .iconfont {
				margin: 0 3px;
				color: inherit;
	...
	.el-menu-horizontal-2 .el-submenu.other ::v-deep .el-submenu__title .el-submenu__icon-arrow {
				margin: -3px 0 0 8px;
				color: inherit;
				vertical-align: middle;
				font-size: 12px;
	...
	.el-menu-horizontal-2 .el-submenu.home ::v-deep .el-submenu__title {
				border: 0;
				cursor: pointer;
				padding: 10px 30px 10px 15px;
				margin: 0;
	...
	.el-menu-horizontal-2 .el-submenu.home ::v-deep .el-submenu__title:hover {
			}
	
	.el-menu-horizontal-2 .el-submenu.home ::v-deep .el-submenu__title .iconfont {
				margin: 0 3px;
				color: inherit;
				display: inline-block;
				vertical-align: middle;
	...
	.el-menu-horizontal-2 .el-submenu.home ::v-deep .el-submenu__title .el-submenu__icon-arrow {
				margin: -3px 0 0 8px;
				color: inherit;
				vertical-align: middle;
				font-size: 12px;
	...
	.el-menu-horizontal-2 .el-submenu.user ::v-deep .el-submenu__title {
				border: 0;
				cursor: pointer;
				padding: 10px 30px 10px 15px;
				margin: 0;
	...
	.el-menu-horizontal-2 .el-submenu.user ::v-deep .el-submenu__title:hover {
			}
	
	.el-menu-horizontal-2 .el-submenu.user ::v-deep .el-submenu__title .iconfont {
				margin: 0 3px;
				color: inherit;
				display: inline-block;
				vertical-align: middle;
	...
	.el-menu-horizontal-2 .el-submenu.user ::v-deep .el-submenu__title .el-submenu__icon-arrow {
				margin: -3px 0 0 8px;
				color: inherit;
				vertical-align: middle;
				font-size: 12px;
